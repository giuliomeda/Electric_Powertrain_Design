...
arc_angle = abs(ang2 - ang1);

if ang2 < ang1
  ang2 = ang1 + arc_angle;
end

arc_angle_avg = (ang2 + ang1)/2;
...
x_arc = (x1-xc)*cosd(arc_angle/2) - (y1-yc)*sind(arc_angle/2) + xc;
y_arc = (x1-xc)*sind(arc_angle/2) + (y1-yc)*cosd(arc_angle/2) + yc;
