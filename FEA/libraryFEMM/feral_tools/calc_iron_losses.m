...
Res.Losses.Lamination.Stator.Teeth.Hysteresis   = StatorKhy * freq^StatorAlphaCoeff * Bmax_t^StatorBetaCoeff * Res.Weight.Stator.Lamination.Teeth * SD.LossesTeethFactor;
Res.Losses.Lamination.Stator.Teeth.EddyCurrent  = StatorKec * (Bmax_t * freq)^2 * Res.Weight.Stator.Lamination.Teeth * SD.LossesTeethFactor;
...
Res.Losses.Lamination.Stator.Yoke.Hysteresis  = StatorKhy * freq^StatorAlphaCoeff * Bmax_yk^StatorBetaCoeff * Res.Weight.Stator.Lamination.Yoke * SD.LossesYokeFactor;
Res.Losses.Lamination.Stator.Yoke.EddyCurrent = StatorKec * (Bmax_yk * freq)^2 * Res.Weight.Stator.Lamination.Yoke * SD.LossesYokeFactor;
